            ...
            >
              ...
              <div className="flex-1 overflow-y-auto px-4 py-3 pb-6 space-y-4 scrollbar-hide relative z-10">
                ...
                <div className="grid grid-cols-2 gap-2.5">
                  ...
                  >
                    <div className="w-10 h-10 rounded-xl bg-[#F2FAFB] group-hover:bg-white flex items-center justify-center text-[#0088A8] transition-colors shadow-xs border border-[#E8F6F8]">
                  ...
                  >
                    <div className="w-10 h-10 rounded-xl bg-[#FDF0F5] group-hover:bg-white flex items-center justify-center text-[#D92B6B] transition-colors shadow-xs border border-[#FCE4EC]">
                ...
                <div className="bg-slate-50 p-3 rounded-2xl border border-slate-200/80 shadow-xs space-y-2">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    <button
                      ...
                      className="flex items-center gap-2 p-2.5 rounded-xl bg-white hover:bg-amber-50 border border-slate-200 hover:border-amber-200 transition-all text-left cursor-pointer shadow-xs group"
                    >
                      ...
                      <div className="min-w-0">
                        <p className="text-xs font-bold text-slate-900 truncate group-hover:text-amber-700">
                          Olma Bricolage
                        </p>
                        <p className="text-[10px] text-slate-500 truncate">Artisans & Pro</p>
                      </div>
                    </button>
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 p-2.5 rounded-xl bg-white hover:bg-emerald-50 border border-slate-200 hover:border-emerald-200 transition-all text-left cursor-pointer shadow-xs group"
                    >
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-[10px] text-slate-500 truncate">Location & Vente</p>
                      </div>
                    </button>
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 p-2.5 rounded-xl bg-white hover:bg-blue-50 border border-slate-200 hover:border-blue-200 transition-all text-left cursor-pointer shadow-xs group"
                    >
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-[10px] text-slate-500 truncate">Marques & Stores</p>
                      </div>
                    </button>
                    ...
                    <button
                      ...
                      className="flex items-center gap-2 p-2.5 rounded-xl bg-white hover:bg-purple-50 border border-slate-200 hover:border-purple-200 transition-all text-left cursor-pointer shadow-xs group"
                    >
                      ...
                      <div className="min-w-0">
                        <p className="text-xs font-bold text-slate-900 truncate group-hover:text-purple-700">
                          Comparateur
                        </p>
                        <p className="text-[10px] text-slate-500 truncate">Prix & Produits</p>
                      </div>
                    </button>
                  </div>
                  ...
                  <div className="grid grid-cols-2 gap-2 pt-1 border-t border-slate-200/60">
                    <button
                      ...
                      className="flex items-center gap-2 p-2 rounded-lg bg-white/70 hover:bg-white text-slate-700 text-xs font-semibold transition-all border border-slate-200/50 cursor-pointer"
                    >
                ...
                <div className="bg-white p-2 rounded-2xl shadow-xs border border-[#E8F6F8]">
                  <button
                    ...
                    className="w-full flex items-center justify-between p-2.5 rounded-xl hover:bg-[#F2FAFB] transition-all cursor-pointer border-none bg-transparent group"
                  >
                    ...
                    <span className="uppercase text-xs text-[#D92B6B] font-bold bg-pink-50 px-2 py-0.5 rounded-md border border-pink-100">
              ...
              <div className="p-3.5 bg-white/95 backdrop-blur-md shrink-0 mt-auto shadow-[0_-8px_30px_-8px_rgba(0,136,168,0.08)] z-20 relative border-t border-cyan-900/5 space-y-2">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 py-2.5 px-3 bg-[#F2FAFB] hover:bg-[#E8F6F8] rounded-xl text-[#0088A8] font-bold text-xs transition-colors cursor-pointer border border-[#E8F6F8] shadow-xs"
                >
