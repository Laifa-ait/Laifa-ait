    ...
    <div className="space-y-4 pt-2 border-t border-slate-200/80">
      ...
      <div className="p-3 rounded-2xl bg-gradient-to-br from-slate-50 to-amber-50/40 border border-slate-200/80 space-y-2">
        <div className="flex items-center gap-2 text-slate-900">
          ...
          <h4 className="text-xs font-bold uppercase tracking-wider">
            {t('artisan_drawer_trust_title', 'Garantie Sérénité Olmart')}
          </h4>
        </div>
        <ul className="text-[11px] text-slate-600 space-y-1.5 pl-0.5">
          <li className="flex items-center gap-1.5">
            <CheckCircle2 className="w-3 h-3 text-emerald-600 shrink-0" />
            <span>{t('artisan_drawer_trust_1', 'Artisans qualifiés & vérifiés manuellement')}</span>
          </li>
          <li className="flex items-center gap-1.5">
            <CheckCircle2 className="w-3 h-3 text-emerald-600 shrink-0" />
            <span>{t('artisan_drawer_trust_2', 'Devis 100% gratuits & sans aucun engagement')}</span>
          </li>
          <li className="flex items-center gap-1.5">
            <CheckCircle2 className="w-3 h-3 text-emerald-600 shrink-0" />
            <span>{t('artisan_drawer_trust_3', 'Paiement direct de gré à gré après travaux')}</span>
          </li>
        </ul>
      </div>
      ...
      <div className="space-y-1">
        <h4 className="text-[10px] font-bold uppercase tracking-wider text-slate-400 px-1 mb-1.5">
          {t('artisan_drawer_eco_title', 'Services de l\'Écosystème Olmart')}
        </h4>
        ...
        >
          <span className="flex items-center gap-2.5">
            ...
            <span>{t('artisan_drawer_eco_shop', 'Marketplace & Outillage')}</span>
          </span>
        ...
        >
          <span className="flex items-center gap-2.5">
            ...
            <span>{t('artisan_drawer_eco_immo', 'Immobilier & Location')}</span>
          </span>
          <ChevronRight className="w-3.5 h-3.5 text-slate-400 rtl:rotate-180" />
        </button>
        ...
        >
          <span className="flex items-center gap-2.5">
            ...
            <span>{t('artisan_drawer_eco_support', 'Centre d\'Aide & Support')}</span>
          </span>
          <ChevronRight className="w-3.5 h-3.5 text-slate-400 rtl:rotate-180" />
        </button>
        ...
        >
          <span className="flex items-center gap-2.5">
            ...
            <span>{t('artisan_drawer_eco_phone', 'Assistance Téléphonique Algérie')}</span>
          </span>
