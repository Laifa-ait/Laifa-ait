      ...
      <AnimatePresence>
        <div className="fixed inset-0 z-40 flex items-center justify-center p-4 bg-slate-950/70 backdrop-blur-sm overflow-y-auto">
          <motion.div
            ...
            className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl shadow-2xl w-full max-w-2xl overflow-hidden my-auto"
          >
            ...
            <form onSubmit={handleSubmit} className="p-6 space-y-4 max-h-[75vh] overflow-y-auto">
              <div className="flex items-center justify-between p-4 bg-slate-50 dark:bg-slate-800/50 rounded-2xl border border-slate-200 dark:border-slate-700">
                <div className="flex items-center gap-4">
                  ...
                  >
                    ...
                    {formData.badge?.fr && (
                      <span
                        className={`absolute -top-2 -right-2 px-1.5 py-0.5 rounded-full text-[9px] font-extrabold shadow uppercase ${
                ...
                <button
                  ...
                  className="px-3.5 py-2 text-xs font-bold bg-orange-500/10 text-orange-600 dark:text-orange-400 hover:bg-orange-500 hover:text-white rounded-xl transition-all flex items-center gap-1.5 border border-orange-500/30"
                >
              ...
              <div className="pt-3 border-t border-slate-200 dark:border-slate-800 flex justify-end gap-2">
                ...
                <button
                  type="submit"
                  className="px-5 py-2 text-xs font-bold rounded-xl bg-orange-600 hover:bg-orange-500 text-white flex items-center gap-1.5 shadow-md shadow-orange-500/20"
                >
