    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/70 backdrop-blur-sm overflow-y-auto">
        <motion.div
          ...
          className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-3xl shadow-2xl w-full max-w-4xl max-h-[90vh] flex flex-col overflow-hidden text-slate-900 dark:text-slate-100 my-auto"
        >
          {/* Header */}
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 flex-1 overflow-hidden">
            ...
            <div className="lg:col-span-7 p-5 flex flex-col border-r border-slate-200 dark:border-slate-800 overflow-y-auto max-h-[60vh] lg:max-h-[70vh]">
              <div className="relative mb-3">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-2.5 text-sm bg-slate-100 dark:bg-slate-800/80 border border-slate-200 dark:border-slate-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-orange-500/50"
                />
              </div>
                    ...
                    <button
                      ...
                      className={`relative flex flex-col items-center justify-center p-3 rounded-2xl border transition-all duration-200 ${
                        isSelected
                          ...
                          : 'bg-slate-50 dark:bg-slate-800/40 border-slate-200 dark:border-slate-800 text-slate-600 dark:text-slate-400 hover:border-slate-300 dark:hover:border-slate-700 hover:bg-white dark:hover:bg-slate-800 hover:scale-102'
                      }`}
                      title={item.name}
                    >
