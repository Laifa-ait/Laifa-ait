    ...
    <div className="space-y-8 bg-zinc-50/50 p-6 sm:p-10 rounded-[3.5rem] border border-zinc-200/50 mt-12">
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        ...
        <button
          ...
          className="px-4 py-2 bg-red-50 hover:bg-red-100 text-red-600 font-sans font-bold text-[9px] uppercase tracking-widest rtl:tracking-normal rounded-2xl transition-colors border-none cursor-pointer self-start sm:self-center"
        >
