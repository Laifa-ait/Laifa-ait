    ...
    <div className="space-y-6">
      ...
      {banners.length === 0 ? (
        ...
        <div className="bg-white rounded-3xl border border-zinc-100 shadow-sm overflow-hidden">
          <div className="p-4 bg-zinc-50/50 border-b border-zinc-100 text-[10px] uppercase font-sans font-bold tracking-widest text-zinc-400 grid grid-cols-1 md:grid-cols-12 gap-4 hidden md:grid">
              ...
              return (
                ...
                >
                  <div className="col-span-full md:col-span-1 flex flex-row md:flex-col items-center justify-center gap-1">
                    ...
                    <span className="text-xs font-sans font-bold text-zinc-800 bg-zinc-100 px-2.5 py-1 rounded-md min-w-[24px] text-center shrink-0">
                  ...
                  <div className="col-span-full md:col-span-3 space-y-2">
                    <div className="flex gap-2.5 justify-center md:justify-start">
                      <div className="relative aspect-[21/9] w-28 rounded-lg overflow-hidden bg-zinc-100 border border-zinc-200 shrink-0">
                        ...
                        />
                        <div className="absolute top-1 start-1 px-1 bg-black/60 rounded text-[7px] text-white uppercase font-sans font-bold">
                          {t("Desktop")}
                        </div>
                      </div>
                      {banner.mobile_image ? (
      ...
      <div className="flex items-center gap-2.5 p-4 bg-orange-50 border border-orange-100/50 rounded-2xl text-[11px] font-bold uppercase tracking-wider text-orange-700">
