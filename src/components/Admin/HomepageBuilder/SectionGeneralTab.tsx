      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 pt-2 border-t border-slate-100">
        <div>
          ...
          <select
            ...
            className="w-full px-3 py-2 text-xs rounded-xl border border-slate-200 bg-white focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 cursor-pointer"
          >
        ...
        <div>
          ...
          >
            <span className={`w-2 h-2 rounded-full ${secIsActive ? "bg-emerald-500" : "bg-slate-400"}`} />
