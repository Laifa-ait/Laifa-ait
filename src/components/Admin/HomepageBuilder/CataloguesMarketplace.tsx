          ...
          {Object.keys(DEFAULT_CATEGORIES).map((catName) => {
            ...
            return (
              <button
                ...
                className={`w-full text-left px-3.5 py-3 rounded-xl font-bold text-xs transition-all cursor-pointer border flex items-center justify-between ${
                  isSelected
              ...
              >
                ...
                <span
                  className={`text-[10px] px-2 py-0.5 rounded-md ${
                    isSelected ? "bg-amber-500 text-slate-950 font-extrabold" : "bg-slate-200 text-slate-600"
                  }`}
                >
      ...
      <div className="lg:col-span-8 bg-white rounded-2xl border border-slate-200 p-6 shadow-sm space-y-6">
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-4 border-b border-slate-100">
          ...
          <button
            ...
            className="flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-bold bg-amber-500 hover:bg-amber-600 text-slate-950 transition-all cursor-pointer disabled:opacity-50"
          >
        ...
        <div className="bg-slate-50 rounded-2xl p-4 border border-slate-200 space-y-3">
          ...
          <div className="relative">
            ...
            <input
              ...
              className="w-full pl-9 pr-3 py-2 text-xs rounded-xl border border-slate-200 bg-white focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500"
            />
          </div>
