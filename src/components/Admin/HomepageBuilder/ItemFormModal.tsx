...
export const ItemFormModal: React.FC<ItemFormModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-xs animate-fade-in" id="item-form-modal">
        ...
        <form onSubmit={handleSaveItem} className="flex-1 overflow-y-auto p-6 space-y-6">
          ...
          <div className="pt-4 border-t border-slate-200 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                type="submit"
                className="flex items-center gap-2 px-5 py-2.5 rounded-xl text-xs font-bold bg-amber-500 hover:bg-amber-600 text-slate-950 shadow-sm transition-all cursor-pointer"
              >
