  ...
  return (
    <div className="absolute inset-0 bg-black/40 backdrop-blur-xs flex items-center justify-center p-4 z-20">
      <form
        ...
        className="bg-white border border-[#e8e2d4] rounded-2xl p-5 w-full max-w-sm space-y-4 shadow-xl text-zinc-800"
      >
        <div className="flex items-center justify-between">
          ...
          <button
            type="button"
            onClick={onClose}
            className="p-1 rounded-lg hover:bg-[#f4ecd8] text-zinc-400 hover:text-[#1e3835] cursor-pointer"
          >
            <X className="w-4 h-4" />
          </button>
        </div>
        ...
        <div className="space-y-2.5 text-xs">
          <label className="block text-zinc-700 font-bold">Motif du signalement :</label>
          <select
            value={reportReason}
            onChange={(e) => setReportReason(e.target.value)}
            className="w-full bg-[#faf8f5] border border-[#e8e2d4] rounded-2xl p-2.5 text-xs text-zinc-900 focus:outline-hidden focus:border-[#1e3835]"
          >
          ...
          <textarea
            ...
            className="w-full bg-[#faf8f5] border border-[#e8e2d4] rounded-2xl p-2.5 text-xs text-zinc-900 placeholder-zinc-400 focus:outline-hidden focus:border-[#1e3835] h-20 resize-none"
          />
        </div>
        ...
        <div className="flex items-center justify-end gap-2 pt-2 border-t border-[#e8e2d4]">
          <button
            type="button"
            onClick={onClose}
            className="px-3.5 py-2 bg-[#f4ecd8] text-[#1e3835] rounded-2xl text-xs font-bold hover:bg-[#ebdcb8] cursor-pointer"
          >
            Annuler
          </button>
          <button
            ...
            className="px-3.5 py-2 bg-rose-600 hover:bg-rose-700 disabled:opacity-50 text-white rounded-2xl text-xs font-bold transition cursor-pointer shadow-xs"
          >
