      ...
      <div className="flex items-center gap-1.5 pointer-events-auto">
        {onRecenter && (
          <button
            type="button"
            onClick={onRecenter}
            className="p-2 rounded-xl bg-white/95 backdrop-blur-md text-[#1E3A8A] shadow-md border border-slate-200 hover:bg-[#1E3A8A] hover:text-white transition-all cursor-pointer group active:scale-95"
            title={recenterTitle}
          >
            <LocateFixed className="w-4 h-4 text-[#1E3A8A] group-hover:text-white" />
          </button>
        )}
        ...
        <button
          ...
          className="px-2.5 py-2 rounded-xl bg-white/95 backdrop-blur-md text-slate-800 shadow-md border border-slate-200 hover:bg-white text-xs font-bold transition-all flex items-center gap-1.5 cursor-pointer active:scale-95"
        ...
        {allowFullscreenToggle && onToggleFullscreen && (
          <button
            ...
            className="p-2 rounded-xl bg-[#1E3A8A] text-white shadow-md hover:bg-blue-900 transition-all cursor-pointer active:scale-95"
