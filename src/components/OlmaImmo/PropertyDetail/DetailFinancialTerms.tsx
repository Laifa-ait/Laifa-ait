      ...
      <div className="flex items-center justify-between pb-3 border-b border-slate-100">
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            aria-label={isOpen ? 'Masquer la catégorie Conditions Financières' : 'Afficher la catégorie Conditions Financières'}
          >
      ...
      {isOpen ? (
        ...
        <div className="p-3.5 rounded-2xl bg-slate-50 border border-slate-200 flex items-center justify-between text-xs text-slate-600">
          <span className="font-semibold text-slate-700">
            {isNegotiable ? 'Prix Négociable' : 'Prix Ferme'} • {isRentLong && advanceMonths ? `Avance de ${advanceMonths} mois • ` : ''}Règlement notarié sécurisé
          </span>
          <button
            type="button"
            onClick={handleToggle}
