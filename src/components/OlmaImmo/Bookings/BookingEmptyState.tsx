  ...
  return (
    <div className="bg-white rounded-2xl p-12 text-center border border-slate-200 shadow-xs space-y-4 max-w-lg mx-auto">
      <div className="w-16 h-16 rounded-2xl bg-slate-100 text-[#1E3A8A] flex items-center justify-center mx-auto border border-slate-200">
        <Palmtree className="w-8 h-8 text-[#F59E0B]" />
      </div>
      ...
      <Link
        ...
        className="inline-flex items-center gap-2 px-6 py-3.5 bg-[#1E3A8A] hover:bg-blue-900 text-white font-bold text-xs rounded-2xl uppercase tracking-wider transition shadow-md hover:shadow-lg mt-2 cursor-pointer"
      >
