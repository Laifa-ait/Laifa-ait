  ...
  return (
    <div className="fixed inset-0 z-50 bg-zinc-950/60 backdrop-blur-md flex items-center justify-center p-4 animate-fadeIn">
      <div className="bg-white rounded-[2rem] border border-zinc-150 p-8 max-w-md w-full relative shadow-2xl space-y-6">
        <button
          onClick={onClose}
          className="absolute end-6 top-6 p-2 text-zinc-400 hover:text-zinc-900 rounded-full hover:bg-transparent transition-all"
        >
          <X className="w-5 h-5" />
        </button>
        ...
        <div className="space-y-4 pt-2">
          <div className="space-y-2">
            <label className="text-[10px] rtl:text-[12px] font-sans font-bold text-zinc-400 uppercase tracking-widest rtl:tracking-normal block leading-none">
            ...
            <input
              ...
              className="w-full px-5 py-4 bg-transparent border border-zinc-200 rounded-2xl font-bold text-xs rtl:text-sm outline-none focus:bg-white focus:ring-4 focus:ring-red-500/10 focus:border-red-500 transition-all"
          ...
          <div className="flex gap-3 pt-4 border-t border-zinc-100">
            <button
              type="button"
              onClick={onClose}
              className="flex-1 py-3.5 border border-zinc-200 text-zinc-700 font-extrabold text-[10px] rtl:text-[12px] uppercase tracking-widest rtl:tracking-normal rounded-2xl hover:bg-transparent active:scale-95 transition-all text-center"
            >
              {t("Annuler")}
            </button>
            <button
              ...
              disabled={loading}
              onClick={onConfirm}
              className="flex-1 py-3.5 bg-red-600 hover:bg-red-700 text-white font-extrabold text-[10px] rtl:text-[12px] uppercase tracking-widest rtl:tracking-normal rounded-2xl disabled:opacity-50 active:scale-95 transition-all text-center"
            >
