...
export const useProductForm = (
  ...
  return {
    ...
    handleFreeTranslateProduct: aiAndTranslate.handleFreeTranslateProduct,
    activeLangTab: aiAndTranslate.activeLangTab,
    setActiveLangTab: aiAndTranslate.setActiveLangTab,
